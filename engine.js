...
const ringCenter = 250;
// REALISTYCZNY PROMIEŃ: Bokserzy stoją blisko, więc ręce nie muszą być z gumy
const combatRadius = 52;      
...
export const boxerRed = {
    ...
    isMovingThisJump: false, wasAboveZero: true, hasHit: false, x: 250, y: 302,
...
export const boxerBlue = { 
    ...
    animTimer: 0, x: 250, y: 198, stunTimer: 0, blockCount: 0, isBlockingNow: false, eyeLevel: 0, lipLevel: 0, liverLevel: 0, hp: 100,
...
export function updatePhysics() {
    ...
    // PORUSZANIE SIĘ PO PRAWDZIWEJ, BLISKIEJ ORBICIE WALKI
    r.x = ringCenter + Math.cos(r.angle) * combatRadius; r.y = ringCenter + Math.sin(r.angle) * combatRadius;
    b.x = ringCenter + Math.cos(r.angle + Math.PI) * combatRadius; b.y = ringCenter + Math.sin(r.angle + Math.PI) * combatRadius;
